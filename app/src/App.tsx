...
import CanvasStateManagementHarnessRoute from './routes/CanvasStateManagementHarnessRoute'
  ...
  return (
    <AppStateProvider>
      <Routes>
        ...
        <Route
          path="/design/components/canvas-state-management-harness"
          element={<CanvasStateManagementHarnessRoute />}
        />
        <Route
